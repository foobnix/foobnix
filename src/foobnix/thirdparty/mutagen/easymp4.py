from foobnix.thirdparty.mutagen import mp4

from foobnix.thirdparty.mutagen import Metadata
from foobnix.thirdparty.mutagen._util import DictMixin, dict_match, utf8
from foobnix.thirdparty.mutagen.mp4 import MP4, MP4Tags, error, delete
