...
from foobnix.thirdparty import mutagen

from foobnix.thirdparty.mutagen import Metadata
from foobnix.thirdparty.mutagen._util import DictMixin, dict_match
from foobnix.thirdparty.mutagen.id3 import ID3, error, delete, ID3FileType
