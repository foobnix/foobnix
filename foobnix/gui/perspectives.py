...
from foobnix.helpers.my_widgets import PerspectiveButton, ButtonStockText
...
class PerspectiveButtonControlls(Gtk.HBox):
    def __init__(self, activate_perspective, controls):
        ...
        vk = PerspectiveButton(_("VK"), Gtk.STOCK_UNINDENT, _("VK Panel (Alt+6)"))
