...
#
from foobnix.thirdparty.mutagen._util import DictMixin
...
def File(filename, options=None, easy=False):
    ...
    if options is None:
        ...
        from foobnix.thirdparty.mutagen.apev2 import APEv2File
        from foobnix.thirdparty.mutagen.flac import FLAC
        if easy:
            from foobnix.thirdparty.mutagen.easyid3 import EasyID3FileType as ID3FileType
        else:
            from foobnix.thirdparty.mutagen.id3 import ID3FileType
        if easy:
            from foobnix.thirdparty.mutagen.mp3 import EasyMP3 as MP3
        else:
        ...
        if easy:
            from foobnix.thirdparty.mutagen.trueaudio import EasyTrueAudio as TrueAudio
        else:
            from foobnix.thirdparty.mutagen.trueaudio import TrueAudio
        from foobnix.thirdparty.mutagen.wavpack import WavPack
        if easy:
            from foobnix.thirdparty.mutagen.easymp4 import EasyMP4 as MP4
        else:
            from foobnix.thirdparty.mutagen.mp4 import MP4
        from foobnix.thirdparty.mutagen.musepack import Musepack
        from foobnix.thirdparty.mutagen.monkeysaudio import MonkeysAudio
        from foobnix.thirdparty.mutagen.optimfrog import OptimFROG
