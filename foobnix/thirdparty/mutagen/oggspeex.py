...
from foobnix.thirdparty.mutagen._vorbis import VCommentDict
from foobnix.thirdparty.mutagen.ogg import OggPage, OggFileType, error as OggError
from foobnix.thirdparty.mutagen._util import cdata
