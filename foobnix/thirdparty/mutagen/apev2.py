...
from foobnix.thirdparty.mutagen import Metadata, FileType
from foobnix.thirdparty.mutagen._util import DictMixin, cdata, utf8, delete_bytes
...
class APEv2(DictMixin, Metadata):
    ...
    def __setitem__(self, key, value):
        ...
        result of that:
            from foobnix.thirdparty.mutagen.apev2 import APEValue, EXTERNAL
